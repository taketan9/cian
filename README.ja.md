...
**会話は続きます。** `:ai` のチャットは、それまでのやり取りを一緒に送ります — 「さっきのやつ」が通じるということです。長くなると**古い手から丸ごと**落とし（半端な手は話者のいない文なので）、**最新の手だけは重くても必ず送ります** — それが次の質問の対象だからです。`:airename` などの構造化した依頼は一問一答のまま。返ってきたものを機械が読むので、前の手は前の手の書式を連れてきます。
